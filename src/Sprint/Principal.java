		...
		do {
			...
			case 1:
				...
				do {
					...
					System.out.println("Ingrese el identificador de la visita en terreno: ");
					String identificadorVisita = scanner.nextLine();

					// Validar Identificador de la visita en terreno
					if (!Validaciones.validarIdentificador(identificadorVisita)) {
						System.out.println("Numero incorrecto, ingrese el identificador correspondiente.");
						continue;
					}
					...
					VisitaEnTerreno visita = new VisitaEnTerreno(Integer.parseInt(identificadorVisita), Integer.parseInt(runCliente),
					...
					do {
						...
						Revision revision = new Revision(Integer.parseInt(identificadorRevision), Integer.parseInt(identificadorVisita), nombreRevision,
			...
			case 4:
				...
				// Validar run del cliente
				if (!Validaciones.validarRun(runClienteCap)) {
					System.out.println("RUN inválido");
					break;
				}
				...
				Capacitacion capacitacion = new Capacitacion(Integer.parseInt(identificadorCapacitacion),Integer.parseInt(runClienteCap),
